...
class Movie(models.Model):
    ...
    url= models.CharField('URL Opción 1:',max_length=200)
    url2= models.CharField('URL Opción 2:',max_length=200,blank=True)
    url3= models.CharField('URL Opción SubEng:',max_length=200,blank=True)
